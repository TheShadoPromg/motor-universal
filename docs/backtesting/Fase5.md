...
Objetivo: obtener métricas 100 % out-of-sample reentrenando las fases de auditoría (2/2.5/3) sólo con Train, y tunear β/λ en Valid antes de medir en Test.

## Resumen del flujo
1) Subset de eventos a Train_struct (ej. 2011-10-19 a 2018-12-31).
2) Reejecuta Fase 2, 2.5 y 3 sólo con ese Train -> genera activadores entrenados (parquet/csv).
3) Tuning de β/λ en Valid (ej. 2019-01-01 a 2022-12-31) usando phase4_tune con activadores TRAIN.
4) Evaluación final en Test (ej. 2023-01-01 a fin de datos) con hiperparámetros fijos.
5) Persistencia completa en Parquet/CSV (sin truncar grids ni resultados).
...
python -m engine.backtesting.phase5_oos \
  ...
  --window-id 1 \
  --train-start 2011-10-19 --train-end 2018-12-31 \
  --valid-start 2019-01-01 --valid-end 2022-12-31 \
...
- Llama a `phase4_tune` con esos activadores TRAIN y los splits Train/Valid/Test proporcionados:
